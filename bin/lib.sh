...
STACKS_UP="storage app consumer api media gateway scheduler broker pdf status geo"
STACKS_DOWN="geo status pdf broker scheduler gateway media api consumer app storage"
