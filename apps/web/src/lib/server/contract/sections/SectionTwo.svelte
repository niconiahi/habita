<p>
  ...
  ABERTURAS: todos los ambientes poseen sus respectivas
  puertas, ventanas y ventanales que se encuentran
  instaladas en perfectas condiciones de uso; CERRADURAS Y
  LLAVES: en perfectas condiciones y funcionando de forma
  correcta. ELECTRODOMESTICOS: el inmueble se encuentra
  equipado con los electrodomésticos acordados entre las
  partes, todos funcionando de forma correcta y en perfectas
  condiciones; INSTALACIONES ELÉCTRICAS Y SANITARIAS: todas
  ellas se encuentran en perfecto estado y funcionando de
