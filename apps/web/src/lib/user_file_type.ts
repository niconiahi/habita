...
export const UserFileTypeSchema = v.picklist(Object.values(USER_FILE_TYPE));
export type UserFileType = ObjectValues<typeof USER_FILE_TYPE>;

export function get_user_file_type_label(type: number | UserFileType) {
