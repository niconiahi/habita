...
This is the endpoint that the digital signature provider (Alpha2000 Firmador) calls after a landlord or tenant completes, rejects, or fails their digital signature. It updates the signature status for the relevant party.
