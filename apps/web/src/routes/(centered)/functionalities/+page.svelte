<div class="page">
  <h1 class="heading-lg title">Funcionalidades</h1>
  ...
  <section>
    ...
    <ul class="features">
      ...
      <li class="body-md-regular">
        Categorizá tu propiedad con 21 diferentes etiquetas
        disponibles
      </li>
      <li class="body-md-regular">
  ...
  <section>
    ...
    <ul class="features">
      <li class="body-md-regular">
        Alertas dentro de la plataforma cuando hay actividad
        relevante
      </li>
      <li class="body-md-regular">
  ...
  <section>
    ...
    <ul class="features">
      ...
      <li class="body-md-regular">
        Cada propiedad muestra fotos, plano, habitaciones y
  ...
  <section>
    ...
    <ul class="features">
      ...
      <li class="body-md-regular">
        ...
        certificante, con la misma validez que una firma
        manuscrita
      </li>
    </ul>
  </section>
...
<style>
  .page {
    ...
    padding-block: var(--dimension-spacing-8);
  }
