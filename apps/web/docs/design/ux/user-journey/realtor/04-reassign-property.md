# Realtor: Reassign a property between managers

## The Lens

**Actor:** Real estate agency owner.

**Goal:** Transfer responsibility for a property from one manager to another within the agency.

**Scenario:** The workload is uneven, or a manager left. The agency owner needs to move a property to a different team member.

---

## The Experience

### Phase 1: Reassign Property
...
**Emotions:** Strategic → Balanced (workload redistributed)
