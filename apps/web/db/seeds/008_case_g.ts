...
export async function seed(_db: Kysely<DB>): Promise<void> {
  ...
  const ground_floor_1_id = await seeder.add_floor(
    property1_id,
  ...
  await seeder.add_room_file(living_room_1_id, photo_id)
  ...
  const ground_floor_2_id = await seeder.add_floor(
    property2_id,
    { number: FLOOR_NUMBER.GROUND },
  )
  ...
  await seeder.add_room_file(living_room_2_id, photo_id)
  ...
  const ground_floor_3_id = await seeder.add_floor(
    property3_id,
    { number: FLOOR_NUMBER.GROUND },
  )
  ...
  await seeder.add_room_file(living_room_3_id, photo_id)
  ...
  const ground_floor_4_id = await seeder.add_floor(
    property4_id,
    { number: FLOOR_NUMBER.GROUND },
  )
  ...
  await seeder.add_room_file(living_room_4_id, photo_id)
